...
# -*- coding: utf-8 -*-
#
# ipysegment documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipysegment', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipysegmentdoc'
...
latex_documents = [
    (master_doc, 'ipysegment.tex', 'ipysegment Documentation',
