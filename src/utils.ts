...
// taken from https://github.com/martinRenou/ipycanvas/blob/4d1fdea1b42bd963115cb881ee9d0810ef2a9913/src/utils.ts
...
export async function toBytes(canvas: HTMLCanvasElement): Promise<Uint8ClampedArray> {
...
export async function fromBytes(array: Uint8ClampedArray): Promise<HTMLImageElement> {
